...
<body style="background-image: url(images/bg2.jpg);">
    ...
    <div class="form" id="aboutus">
        <form class="box2">
           ...
           <div class="cont">
               <img src="images/Male_Dev.jpg" alt="FS19CO004">
               <div class="info">
                   <ul>
                       <a href="https://www.linkedin.com/in/tejas-hande-84b73021a">Tejas Hande</a><br>
                       <li>9867556536</li><br>
                       <li><a href="mailto:tejashande08@gmail.com">tejashande08@gmail.com</a></li><br>
                       <li>Government Polytechnic, Mumbai</li><br>
                   </ul>
               </div>
           </div>
           <div class="cont">
               <img src="images/Fem_Dev.jpg" alt="FS19CO015">
               <div class="info">
                   <ul>
                       <a href="https://www.linkedin.com/in/namrata-bidaye-050774219">Namrata Bidaye</a><br>
                       <li>7020091305</li><br>
                       <li><a href="mailto:namratabidaye33@gmail.com">namratabidaye33@gmail.com</a></li><br>
                       <li>Government Polytechnic, Mumbai</li><br>
                   </ul>
               </div>
           </div>
           <div class="cont">
               <img src="images/Fem_Dev.jpg" alt="FS19CO016">
               <div class="info">
                   <ul>
                       <a href="https://www.linkedin.com/in/sakshi-sali-453b2621a">Sakshi Sali</a><br>
                       <li>6355214530</li><br>
                       <li><a href="mailto:sakshisali.30@gmail.com">sakshisali.30@gmail.com</a></li><br>
                       <li>Government Polytechnic, Mumbai</li><br>
                   </ul>
               </div>
           </div>
           <div class="cont">
               <img src="images/Fem_Dev.jpg" alt="FS19CO007">
               <div class="info">
                   <ul>
